...
Ветвления в Гит нужны для создания цепочки последовательных коммито. Ветка представляет собой историю изменений репозитория.

Главная ветка по умолчанию имеются "master" или "main. Названия остальным веткам придумывает разработчик при создании, в которых должны отражться назначения веток.
...
Удаленные репозитории нужны для того, чтобы работать в одном проекте с разных устройств или в команде.
